...
public static class ClassSpecNames
{
    ...
    public static (string? ClassName, string? SpecName) Get(int? classId, int? specId)
    {
        var className = classId is null ? null : Classes.GetValueOrDefault(classId.Value, $"职业{classId}");
        var specName = classId is null || specId is null
            ? null
