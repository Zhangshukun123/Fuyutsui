...
def run_druid_logic(state_dict, spec_name):
    ...
    if spec_name == "平衡":
        ...
        无回春最低, 无回春最低血量 = get_lowest_health_unit_with_aura_count(state_dict, "回春数量", 0, health_threshold=101)
        单回春最低, 单回春血量最低 = get_lowest_health_unit_with_aura_count(state_dict, "回春数量", 1, health_threshold=101)
